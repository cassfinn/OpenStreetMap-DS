...
Benefits of Government Responsibility:
 - The OSM data could be useful for both public and private interests if the quality of the data was improved. The government could add layers and amenities which Google and other sources may not have access to, but which could lead to growth in profits and quality of life for businesses and residents. 
